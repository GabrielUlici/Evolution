  ...
  $tel1=$_POST['tel1'];
  $sql="insert into prof(iuser,pass,nume,prenume,email,dn_an,dn_luna,dn_zi,sex,adresa,tara,judet,localitate,cod_postal,tel1,date1)values('".$iuser."','".$pass."','".$nume."','".$prenume."','".$email."','".$dn_an."','".$dn_luna."','".$dn_zi."','".$sex."','".$adresa."','".$tara."','".$judet."','".$localitate."','".$cod_postal."','".$tel1."',now())";
...
<form action="inscriere_prof.php" method="post">
