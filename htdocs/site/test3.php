...
if ($q1 == "vector si imagine") {
  $nota=$nota+2;
}
if ($q2 == "") {
  die ("Ai uitat sa complectezi ceva!!!!");
}
if ($q2 == "continutul compus al filmului") {
  $nota=$nota+2;
}
if ($q3 == "") {
  die ("Ai uitat sa complectezi ceva!!!!");
}
if ($q3 == "manipularea obiectului intr-un anumit fel") {
  $nota=$nota+2;
}
if ($q4 == "") {
  die ("Ai uitat sa complectezi ceva!!!!");
}
if ($q4 == "importa o forma intr-un anumit moment de timp") {
  $nota=$nota+2;
}
if ($q5 == "") {
  die ("Ai uitat sa complectezi ceva!!!!");
}
if ($q5 == "un limbaj folosit pentru dezvoltarea functiionalitati in cadrul animatilor") {
  $nota=$nota+2;
}
